-- ستون‌های یوزرنیم و شماره همراه
...
-- ذخیره‌ی یوزرنیم/شماره هنگام ثبت‌نام
...
-- بررسی در دسترس بودن یوزرنیم/شماره قبل از ثبت‌نام (باید برای کاربر مهمان هم قابل صدا زدن باشد)
...
-- تبدیل شماره/یوزرنیم به ایمیل داخلی حساب، برای فرم ورود
